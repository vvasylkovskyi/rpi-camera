from pijuice import PiJuice # https://github.com/PiSupply/PiJuice/blob/master/Software/Source/pijuice.py
...
class PiJuiceBattery:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance.logger = Logger("PiJuiceBattery")
    ...
    def get_system_power_switch(self):
        ...
        try:
            ...
            self.logger.info(f"System power switch state: {system_power_switch['data']}")
    ...
    def get_battery_profile_status(self):
        ...
        try:
            ...
            self.logger.info(f"Battery profile status: {battery_profile_status['data']}")
    ...
    def get_battery_temp_sense_config(self):
        ...
        try:
            ...
            self.logger.info(f"Battery temperature sense configuration: {temp_sense_config['data']}")
            return temp_sense_config['data']
        except Exception as e:
            self.logger.error(f"Failed to get battery temperature sense configuration: {e}")
            return None
    ...
    def set_battery_temp_sense_config(self, config):
        ...
        try:
            ...
            self.logger.success("Battery temperature sense configuration set successfully.")
        except Exception as e:
            self.logger.error(f"Failed to set battery temperature sense configuration: {e}")